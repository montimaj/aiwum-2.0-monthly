...
The predictor variables include latitude, longitude, crop type, precipitation, maximum temperature (the average daily maximum from April - September), total evapotranspiration estimated with SSEBop, surface run-off and soil moisture (TerraClimate). A table summary of the predictor variables is given below.
...
| Precipitation                        | Monthly Sum (temporal) | Entire year         | 800                    | [Daly et al. (1997)](https://prism.oregonstate.edu/documents/pubs/1997appclim_PRISMapproach_daly.pdf) |                                                                                                         |
